...
class Game(db.Model):
    ...
    publisher: so.Mapped['Publisher'] = so.relationship('Publisher', secondary='game_publisher', back_populates='games') # type: ignore
    genres: so.Mapped['Genre'] = so.relationship('Genre', secondary='game_genre', back_populates='games') # type: ignore    
